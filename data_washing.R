...
easter_egg<- tibble(
  ...
  pubPri = "Private",
  category = list("Top University"),
  introduction = "Tracing its origins to 1838, Duke University has evolved into one of the world's leading institutions for education, research and patient care. Located in Durham, North Carolina, Duke is comprised of two major organizations: Duke University and Duke University Health System.",
  ...
  happy_poll = 1,
  population = 16780,
  teacher_student_ratio = 4,
  lat = 36.0014,
  lng = -78.9382,
  grad_rate = 0.96,
  SAT = 1510,
  ACT = 35,
  programs = list(c("Undergraduate", "Graduate", "Professional")),
  peopleRated = 1838,
  meanRating = 4.9,
  Academics = "A+",
  Diversity = "A+",
...
tidy_df<-tidy_df %>% add_row(easter_egg)
